...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			case 'keystone' | 'confusion' | 'psyshock':
					hasDialog = true;
		...
		portraitLeft.frames = Paths.getSparrowAtlas('portrait/gardePortrait');
		...
		portraitRight.frames = Paths.getSparrowAtlas('portrait/bfPortrait');
		...
		switch (curCharacter)
		{
			...
			case 'garde2':
				...
				portraitLeft.visible = false;
					...
					portraitLeft.visible = true;
					portraitLeft.frames = Paths.getSparrowAtlas('portrait/megaGardePortrait');
					portraitLeft.animation.addByPrefix('enter', 'Senpai Portrait Enter', 24, false);
					portraitLeft.animation.play('enter');
			...
			portraitLeft.visible = false;
					...
					portraitRight.visible = true;
					portraitRight.frames = Paths.getSparrowAtlas('portrait/gfPortrait');
