...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'keystone':
				dialogue = CoolUtil.coolTextFile(Paths.txt('keystone/Dia3'));
			case 'psyshock':
				dialogue = CoolUtil.coolTextFile(Paths.txt('psyshock/Dia2'));
			case 'confusion':
				dialogue = CoolUtil.coolTextFile(Paths.txt('confusion/Dia1'));
		}
			...
			case 'poke':
				{
						defaultCamZoom = 0.9;
						curStage = 'poke';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('Garde BG'));
						bg.antialiasing = true;
